...
let successDiaryData = [  
    ...
    },
    {
        ...
        headline: {
            zh: '读完《指数基金掉头指南》',
            en: 'Finished reading “A Guide to Index Fund Dollar-Cost Averaging”'
        },
        content: {
            zh: '❌',
            en: '❌'
    ...
    },
      {
        ...
        highlight: {
            zh: '学习时长增加50%',
            en: 'Study duration increased by 50%.'
        },
        notes: {
            zh: '',
            en: ''
    ...
    },
     {
        ...
        highlight: {
            zh: '每日规划表优化',
            en: 'Optimization of daily planning schedules.'
        },
        notes: {
            zh: '',
            en: ''
    ...
    },
      {
        ...
        highlight: {
            zh: '历史调研室-撒切尔；唐诡3',
            en: 'Historical Research Room - Thatcher; Tang Guai 3'
        },
        notes: {
            zh: '',
            en: ''
    ...
    },
     {
    ...
    },
       {
        ...
        highlight: {
            zh: '葡萄不错，完成了今日6作',
            en: 'The grapes are quite good, and today is task of completing six items has been accomplished.'
        },
        notes: {
            zh: '',
            en: ''
    ...
    },
     {
        ...
        highlight: {
            zh: '选择题❌问答题✅',
            en: 'Choice question❌Question and answer questions✅'
        },
        notes: {
            zh: '',
            en: ''
    ...
    },
      {
        ...
        highlight: {
            zh: '前哨战学习-想节流的唯一核心，热爱工作',
            en: 'Frontline Learning - The Sole Core of Seeking Efficiency, Passion for Work'
        },
        notes: {
            zh: '',
            en: ''
...
let momentsData = [
    ...
    value: 10,
    category: '科技数码',
    date: '2025-11-19T13:15:00+08:00',
    images: ["images/668f218ed969e97b1d23811055c5e709.png"],
    likes: 0,
    comments: []
  },
     {
    ...
    comments: []
     ...
     {
    id: 37,
    content: '阅读输出：热爱,赋予重大意义，每天去图书馆学习12小时，给那些摆烂躺平的看看，这个世界上牛的人能努力到什么样，代表这个时代的年轻人，面对接下来波谲云诡的AI时代，旧的秩序坍塌，新的城邦建立，经验主义越来越无用，死气沉沉本不应该存在，新时期的应对方法,是用"拉力"代替"推力"。也就是说,关键不在于你事先把多少资源"推"到这里等着灾难发生,而在于等到黑天鹅事件发生以后,你能不能迅速把资源"拉"过来;先做起来再说,太过追求安全你就什么都赶不上,敢于冒险、有想法赶紧尝试才是时代特色;"不团结",往往是创造力的来源。在这个时代"违抗"比"服从"更有价值,有很多科学发现是科学家违抗上级命令,自己单干的结果-没有人是靠别人告诉他怎么做而得到诺贝尔奖的。',
    value: 6,
    category: '学习成长',
    date: '2025-11-10T23:30:00+08:00',
    images: [],
    likes: 0,
    comments: []
  },
